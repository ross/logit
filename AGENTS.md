...
([ADR `native-wire-format-encoding`](docs/adr/native-wire-format-encoding.md)). The connection
layer is real now too: `logit_in`/`logit_out` (`crates/logit-inputs/src/logit.rs`/`crates/

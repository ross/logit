...
/// `logit_proto::graphite::Protocol` -- same reasoning as [`graphite_transport`]. Graph rule 43 is
...
mod tests {
    ...
    /// Every `transport`/`protocol` pair rule 43 permits builds a real input, and the `receive:`

...
/// default plaintext listener (port 2003); `udp` is plaintext-only -- rule 43 rejects
...
/// carbon's own default listener protocol; `pickle` is the batch protocol, TCP only (rule 43).

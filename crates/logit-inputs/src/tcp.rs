...
///
/// `pub(crate)` because `crate::logit`'s own idle deadline wants the identical fallback and
/// tokio's copy is out of reach there too -- one definition rather than two 30-year constants
/// drifting apart.

...
//! `docs/adr/0019-buffered-sink-delivery.md` for why the ack shape is `peek`/`commit` rather than
...
/// (`peek`/`commit`, not `pop`) -- see `docs/adr/0019-buffered-sink-delivery.md`.
pub trait Buffer<T> {

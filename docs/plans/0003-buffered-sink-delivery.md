...
**Decisions to record:** draft **ADR 0019** here (Status: Proposed) so later workstreams can cite
...
`docs/design/wire-protocol.md`, `docs/adr/0019-buffered-sink-delivery.md` (new, drafted here).
...
> wrong, both corrected during review and recorded in `docs/adr/0019-buffered-sink-delivery.md`'s
...
**Decisions to record:** finalize **ADR 0019** to Accepted, including the failure-handling
decision below; add a short "Revised by ADR 0019" note to ADR 0013's retry section (0013 is not
...
`docs/adr/0019-buffered-sink-delivery.md`, `docs/adr/0013-service-lifecycle-and-output-retry.md`.

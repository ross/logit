...
| W4 | `otlp_out` to Observability Cloud verified against a trial org (traces over HTTP and gRPC, metrics over HTTP with an explicit-bucket histogram); `fixtures/splunk-observability.yaml` | S | W3 |

# 0006 — Developer workflow: Scripts to Rule Them All, and PR-based development

## Status
Accepted

## Context
[ADR 0005](0005-containerized-development.md) got the dev environment itself containerized, but
...
resolves the `DOCKER` override from [ADR 0005](0005-containerized-development.md), and a `run()`

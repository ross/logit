...
## Context
`docs/plans/nginx-integration.md`'s workstream B works backward from one property of the
...
> **Revised by [ADR `buffered-sink-delivery`](buffered-sink-delivery.md).** The ~5s default budget below is

...
`drain_inbox` (`runtime.rs`, [ADR 0019](../adr/0019-buffered-sink-delivery.md)), which moves it off
...
**This likelihood flipped with [ADR 0019](../adr/0019-buffered-sink-delivery.md).** Before it,
...
(`docs/plans/0003-buffered-sink-delivery.md`, `docs/adr/0019-buffered-sink-delivery.md`): every

...
pub enum ComponentKind {
    ...
    // logfmt, kv, regex, rename, filter, sample, throttle, dedup —
...
| Transform (`lua`, `lua_file`, `aggregate`, `json`, `csv`, `kv_metrics`, `keep`, `remove`, `set`, `trace_context`, `scale`, `has_signal`, `keep_signals`, `drop_signals`) | ≥1 required | required (≥1 consumer) |
